const Services = () => {
    return (
        <section className="pb-12 pt-20 p-6 lg:pb-[90px] lg:pt-[120px] ">
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
                ...
                <h2
                  className="mb-3 text-3xl font-bold leading-[1.2] text-dark sm:text-4xl md:text-[40px] "
                >
                  What We Offer
                </h2>
                <p className="text-base text-body-color ">
                With Ai, we teach core moral values and ask challenging moral questions.
                </p>
              </div>
            </div>
          </div>
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              ...
              >
                ...
                Dive into interactive lessons on corruption, its impact, and ways to prevent it. We break down complex concepts into easy-to-understand content, ensuring that everyone can learn about integrity and ethical behavior.
                </p>
              </div>
            </div>
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              ...
              >
                ...
                <h4
                  className="mb-[14px] text-2xl font-semibold text-dark "
                >
                Take Quizzes, Earn Points: 
                </h4>
                <p className="text-body-color ">
                Test your knowledge through engaging quizzes. The more questions you answer correctly, the more points you earn! Challenge yourself and see how well you understand corruption.
                </p>
              </div>
            </div>
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              ...
              >
                ...
                <h4
                  className="mb-[14px] text-2xl font-semibold text-dark "
                >
                  Save Points on the Internet Computer: 
                </h4>
                <p className="text-body-color ">
                Your earned points aren’t just for show! They are securely saved on the Internet Computer, where you can track and redeem them for exciting rewards. The blockchain ensures your points are safe and transparent.
                </p>
              </div>
            </div>
          </div>
