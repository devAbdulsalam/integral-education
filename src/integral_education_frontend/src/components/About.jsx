	...
	return (
		...
		>
			<div
				...
				aria-hidden="true"
			>
				<div className="relative right-1/2 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr via-[#8088ff] from-[#9B317B]  to-[#682B7E] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem] clipPath"></div>
			</div>
			<div className="text-2xl font-semibold mb-6 text-center">
				<h2 className="text-3xl font-extrabold text-primary">Why QuizMe?</h2>
			...
			<div className="py-10 grid md:grid-cols-2 lg:grid-cols-3 place-items-center gap-4 space-x-4 text-center md:w-10/12 mx-auto">
				<div className="p-2 w-full mx-auto bg-white md:p-8 rounded-lg shadow">
					<button className=" feature-1 rounded-full text-center text-primary text-2xl font-semibold">
						<p className="p-4 px-6">1</p>
					</button>
					<h2 className="text-xl font-bold my-2 hero">Interactive Learning</h2>
					<div className="mt-2">
				...
				<div className="p-2 w-full mx-auto bg-white md:p-8 rounded-lg shadow">
					<button className=" feature-2 rounded-full text-center text-primary text-2xl font-semibold">
						<p className="p-4 px-6">2</p>
					</button>
					<h2 className="text-xl hero font-bold my-2">Earn Rewards.</h2>
					<div className="mt-2">
						<p className="leadinig text-left">
				...
				<div className="p-2 w-full mx-auto bg-white md:p-8 rounded-lg shadow">
					<button className="feature-3 text-center rounded-full text-primary text-2xl font-semibold">
						<p className="p-4 px-6">3</p>
					</button>
					<h2 className="text-xl hero font-bold my-2">
					Blockchain Security: 
					</h2>
					<div className="mt-2">
						<p className="leadinig text-left">
